...
#/home/wull01/ACBE_endomodel_reanalysis/BE_Endo/model_data_seq/ABE_Seq/ABE_Seq.h5
   ...
   'base9', 'base10', 'base11', 'base12', 'base13', 'base14', 'base15',
   'base16', 'base17', 'base18', 'base19', 'base20']].to_csv(out_file+".{}.Seq.eff".format(Editor,),sep="\t",index=None)
   ...
   Proportion_df_single_clean.to_csv(out_file+".{}.{}.proportion".format(Editor,single_factor),sep="\t",index=None)
   Proportion_df_seq_clean.to_csv(out_file+".{}.{}.proportion".format(Editor,"Seq"),sep="\t",index=None)
